...
//==============================================================================
const String MyEqAudioProcessor::getName() const
{
...
const String MyEqAudioProcessor::getProgramName (int index)
{
    return {};
}

void MyEqAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
AudioProcessorEditor* MyEqAudioProcessor::createEditor()
{
    return new MyEqAudioProcessorEditor (*this);
}

//==============================================================================
void MyEqAudioProcessor::getStateInformation (MemoryBlock& destData)
{
